  ...
  return (
    <AnimatePresence mode="wait">
      {!showContent && (
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.08),transparent_35%),linear-gradient(135deg,#11021C_0%,#0b0114_38%,#07010f_65%,#04000a_100%)]" />
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {petals.map((petal) => (
              ...
              >
                <div
                  className="h-5 w-3 rounded-full bg-gradient-to-b from-[#e0c5ed] via-[#532175] to-[#0b0114] shadow-[0_0_14px_rgba(183,228,199,0.15)]"
                  style={{
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex h-[58%] flex-col items-center justify-end px-8 pb-4 sm:pb-6 text-center">
                    ...
                    >
                      <h3 className="font-serif text-[1.7rem] tracking-[0.14em] text-[#2d0c45] drop-shadow-[0_2px_8px_rgba(0,0,0,0.18)] flex items-center justify-center gap-4 sm:gap-6">
                        <span>T</span>
                  ...
                  <motion.div
                    ...
                    className="absolute left-1/2 top-[54%] z-20 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[#f2d89c]/40 bg-[radial-gradient(circle_at_30%_30%,#833ab4_0%,#11021C_55%,#07010f_100%)] shadow-[0_10px_30px_rgba(1,31,26,0.45)]"
                  >
                    <span className="font-serif text-lg text-[#f5e6c8]">G ✦ R</span>
                  </motion.div>
                ...
                >
                  <div className="relative overflow-hidden rounded-[24px] border border-[#C9A227]/35 bg-[linear-gradient(180deg,rgba(248,236,214,0.98)_0%,rgba(255,252,247,0.99)_100%)] px-8 py-10 shadow-[0_25px_60px_rgba(0,0,0,0.28)]">
                    ...
                    <div className="relative text-center">
                      ...
                      <h2 className="mt-5 font-serif text-4xl font-light tracking-[0.08em] text-[#2d0c45]">
                        GOSITHA
                      </h2>
                      <p className="mt-1 font-serif text-lg italic text-[#b08a1f]">&</p>
                      <h2 className="font-serif text-4xl font-light tracking-[0.08em] text-[#2d0c45]">
                        RANGIKA
                      </h2>
