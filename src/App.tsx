...
function CountdownTimer() {
  ...
  const targetDate = useMemo(() => new Date("August 27, 2026 18:00:00").getTime(), []);
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 md:py-36 bg-gradient-to-br from-[#1a0524] via-[#3e1459] to-[#1a0524] flex flex-col items-center overflow-hidden z-20"
    >
      {/* Texture & Glow Layer */}
      ...
      <div className="w-full max-w-6xl px-6 flex flex-col items-center text-center relative z-10">
        ...
        >
          ...
          <h2 className="font-script text-6xl md:text-[8rem] leading-tight text-white drop-shadow-xl">
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      >
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-[#fcfcf0]">
          <div>
            <h2 className="font-cinzel text-xl md:text-2xl text-[#3e1459] font-bold">Accommodation Rates</h2>
            <p className="text-[10px] uppercase tracking-widest text-[#3e1459] mt-1">Godagama Reach Hotel</p>
          </div>
          ...
          <div className="space-y-12">
            <div>
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px flex-1 bg-[#3e1459]/30" />
                <h3 className="font-playball text-3xl text-[#3e1459]">Honeymoon Room Rates</h3>
                <div className="h-px flex-1 bg-[#3e1459]/30" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                {honeymoonRates.map((plan) => (
                  <div key={plan.plan} className="bg-white p-6 rounded-xl border border-[#7a3899]/30 shadow-sm">
                    <h4 className="font-cinzel text-sm font-bold text-[#3e1459] mb-4 border-b border-[#7a3899]/20 pb-2">{plan.plan}</h4>
                    <div className="space-y-3">
                      {plan.rooms.map((room) => (
                        <div key={room.name} className="flex justify-between items-center gap-4">
                          ...
                          <p className="text-xs font-bold text-[#3e1459] whitespace-nowrap">{room.rate}</p>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px flex-1 bg-[#3e1459]/30" />
                <h3 className="font-playball text-3xl text-[#3e1459]">Double Room Rates</h3>
                <div className="h-px flex-1 bg-[#3e1459]/30" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
              <div className="text-center">
                ...
                <p className="font-cinzel text-xl text-[#3e1459]">2:00 PM</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Check Out</p>
                <p className="font-cinzel text-xl text-[#3e1459]">12:00 PM</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Availability</p>
                <p className="font-cinzel text-sm text-[#3e1459] leading-tight">Max 16 Rooms Available</p>
              </div>
            </div>
          </div>
        </div>
...
export default function WeddingInvitation() {
  ...
  const [introPhase, setIntroPhase] = useState<'waiting' | 'playing'>('waiting');
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {!isOpened ? (
          ...
          >
            <video
              id="intro-video"
              loop={introPhase === 'waiting'}
              autoPlay
              muted={introPhase === 'waiting'}
              playsInline
              onEnded={() => {
              ...
              className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 ${
                introPhase === 'waiting' ? 'blur-xl scale-105 opacity-60' : 'blur-0 scale-100 opacity-100'
              }`}
            >
              ...
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/40">
                <motion.button
                  ...
                  onClick={() => {
                    ...
                    if (vid) {
                      vid.currentTime = 0;
                      vid.muted = true; // Keep muted so background music plays clearly
                      vid.loop = false;
                      vid.play().catch(console.error);
                    }
                    void unlockAudioFromGesture(); // Start background music immediately
                    setIntroPhase('playing');
                  }}
                  className="px-10 py-5 bg-[linear-gradient(135deg,#c9a227_0%,#e0c46d_50%,#a57b16_100%)] text-[#1a0524] rounded-full font-cinzel font-bold tracking-[0.2em] shadow-[0_10px_30px_rgba(201,162,39,0.3)] border border-[#f5e6c8]/50 uppercase text-sm md:text-base flex items-center gap-3 transition-all hover:shadow-[0_15px_40px_rgba(201,162,39,0.5)]"
                >
                  View Invitation
                  <Sparkles className="w-5 h-5 text-[#1a0524]" />
                </motion.button>
              </div>
            )}
            ...
            {introPhase === 'playing' && (
               <button
                  ...
                  className="absolute top-8 right-8 z-20 text-white/70 hover:text-white px-5 py-2 text-[10px] tracking-[0.3em] font-montserrat uppercase border border-white/30 rounded-full backdrop-blur-sm transition-all hover:bg-white/10"
               >
                  Skip
               </button>
            )}
          ...
          >
            ...
            <section className="relative z-10 flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-black">
            ...
            <section className="relative py-24 md:py-36 w-full flex flex-col items-center overflow-hidden z-10 border-b-[0.5px] border-[#d4af37]/30 bg-[#fdfaf5]">
              ...
              {/* Elegant accents for 'Premium' feel */}
              <motion.div
                animate={{ scale: [1, 1.2, 1], rotate: [0, 15, 0] }}
                transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
                className="absolute top-10 right-10 text-[#d4af37] opacity-40"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-10 left-10 text-[#d4af37] opacity-40"
              >
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center gap-16 lg:gap-32 mt-4 mb-16">
                  ...
                  >
                    <div className="w-full flex justify-center md:justify-start overflow-hidden">
                      <h3 className="text-[3.5rem] sm:text-6xl md:text-[8rem] lg:text-[9rem] font-playball text-gold-gradient leading-none drop-shadow-sm px-2 pb-2">
                        Gositha
                      </h3>
                    </div>
                    ...
                    <div className="w-full flex justify-center md:justify-start overflow-hidden">
                      <h3 className="text-[3.5rem] sm:text-6xl md:text-[8rem] lg:text-[9rem] font-playball text-gold-gradient leading-none drop-shadow-sm px-2 pt-2">
                        Rangika
                      </h3>
                    </div>

                    <div className="pt-6 md:pt-8 w-full">
                      {/* Parent names removed */}
                    </div>
                  </motion.div>
                </div>
              </div>
              ...
              <div className="container mx-auto px-6 max-w-6xl relative z-10">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 mb-2">
                        <div className="w-12 h-[1px] bg-[#3e1459]" />
                        <span className="text-[#C9A227]">✦</span>
                        <span className="text-[#3e1459] font-bold uppercase tracking-[0.4em] text-[10px]">
                          T H E | V E N U E
                        </span>
                      </div>
                      <h2 className="font-cinzel text-[2.5rem] md:text-[4rem] text-[#3e1459] leading-tight tracking-widest font-bold uppercase">
                        Godagama Reach Hotel
                      </h2>
                      <p className="font-playball text-3xl md:text-5xl text-[#3e1459] italic mt-2">
                        ORCHID HALL
                      </p>
                    </div>

                    <div className="space-y-8 pl-6 border-l border-[#7a3899]/40">
                      <div className="flex items-start gap-4">
                        <MapPin className="w-5 h-5 text-[#3e1459] mt-1 shrink-0" />
                        <p className="text-lg md:text-xl text-[#3e1459] font-cinzel leading-relaxed tracking-wide uppercase">
                          Godagama Reach Hotel.
                        </p>
                      </div>
                      <p className="text-[#3e1459]/70 text-sm md:text-base tracking-widest uppercase font-light leading-loose">
                        AT SIX O'CLOCK IN THE EVENING. AUGUST 27, 2026. RECEPTION TO FOLLOW.
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button
                        onClick={() =>
                          window.open("https://maps.app.goo.gl/toYyFJBAwNvGWs35A", "_blank")
                        }
                        className="group relative inline-flex items-center justify-center gap-4 px-10 py-5 bg-[#3e1459] text-white text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] overflow-hidden transition-all hover:bg-[#2a0a3f]"
                      >
                  ...
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative w-full aspect-[3/4] max-w-[450px] mx-auto bg-white p-3 shadow-[0_40px_80px_-20px_rgba(135,147,122,0.2)] border border-[#7a3899]/50"
                  >
                    <div className="absolute inset-2 border-[0.5px] border-[#3e1459]/30 pointer-events-none z-20" />
                    <div className="w-full h-full overflow-hidden bg-white relative">
                      <iframe
                        src="https://maps.google.com/maps?q=Godagama%20Reach%20Hotel&t=&z=16&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
                ...
                <div className="relative w-full max-w-[550px] aspect-[4/5] flex items-center justify-center pt-12 md:pt-24 mt-12 md:mt-0">
                  ...
                  >
                    <img
                      src="/images/12.png"
                      alt=""
                      className="absolute inset-0 w-full h-full object-contain object-bottom drop-shadow-sm opacity-90 hue-rotate-[240deg]"
                    />
                    <img
                      src="/images/12.png"
                      alt=""
                      className="absolute inset-0 w-full h-full object-contain object-bottom scale-x-[-1] -rotate-12 translate-x-12 opacity-80 hue-rotate-[240deg]"
                    />
                    <img
                      src="/images/12.png"
                      alt=""
                      className="absolute inset-0 w-full h-full object-contain object-bottom rotate-[15deg] -translate-x-12 opacity-70 hue-rotate-[240deg]"
                    />
                    <img
                      src="/images/12.png"
                      alt=""
                      className="absolute inset-0 w-full h-full object-contain object-bottom scale-75 translate-y-12 opacity-60 hue-rotate-[240deg]"
                    />
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="w-full flex flex-col items-center mt-6 relative z-10 px-2 md:px-6">
                      <p className="font-montserrat text-[10px] md:text-[11px] tracking-[0.2em] text-slate-500 uppercase font-medium mb-2 text-center leading-relaxed">
                        RSVP - GOSITHA 076 337 2265 | RANGIKA 076 413 6862
                      </p>
            ...
            <div className="relative bg-[#7a3899]/10">
              <div className="absolute inset-0 opacity-[0.03] bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')] pointer-events-none" />
              ...
              <section className="relative py-24 md:py-36 flex flex-col items-center overflow-hidden">
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#3e1459]/10 mb-8 mt-4 shadow-sm border border-[#3e1459]/20">
                      <Sparkles className="w-8 h-8 text-[#3e1459]" />
                    </div>

                    <h2 className="font-script text-[4.5rem] sm:text-[5rem] md:text-[7rem] text-[#3e1459] mb-6 drop-shadow-sm leading-none">
                      Best Wishes
                    </h2>
                    <div className="h-px w-24 bg-[#7a3899] mb-8" />

                    <p className="text-[#3e1459] text-sm md:text-lg leading-relaxed max-w-xl mx-auto mb-16 font-serif tracking-[0.1em] px-4 uppercase font-bold">
                    ...
                    <div className="w-full max-w-2xl mx-auto bg-white p-8 md:p-14 shadow-[0_30px_70px_-15px_rgba(6,78,59,0.1)] border border-[#7a3899]/50 relative group card-marble">
                      <div className="absolute inset-0 gold-foil-edge opacity-20 pointer-events-none" />
                      <div className="absolute inset-2 border-[0.5px] border-[#3e1459]/20 pointer-events-none transition-colors duration-700" />

                      <form className="space-y-12 text-left relative z-10" onSubmit={handleWishSubmit}>
                        <div className="space-y-4">
                          <label className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#3e1459]/40">
                            From
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full bg-transparent border-b border-[#7a3899]/40 px-0 py-4 text-[#3e1459] placeholder:text-[#7a3899]/30 focus:outline-none focus:border-[#3e1459] transition-all font-cinzel text-lg tracking-widest"
                            required
                          />
                        </div>
                        <div className="space-y-4">
                          ...
                          <textarea
                            ...
                            className="w-full bg-transparent border-b border-[#7a3899]/40 px-0 py-4 text-[#3e1459] placeholder:text-[#7a3899]/30 focus:outline-none focus:border-[#3e1459] transition-all font-cinzel text-lg tracking-widest resize-none"
                            required
                          />
                        </div>
                        ...
                        <div className="pt-6 flex justify-center">
                          <button
                            ...
                            className="bg-[#3e1459] text-white px-12 py-5 font-bold uppercase tracking-[0.4em] text-[10px] hover:bg-[#2a0a3f] transition-all duration-300 shadow-md disabled:opacity-70"
                          >
                ...
                <div className="w-full max-w-4xl px-6 flex flex-col items-center text-center relative z-20">
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-6 mt-4">
                      <h2 className="font-script text-5xl md:text-7xl text-gold-gradient py-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)] leading-none">
                        Gositha
                      </h2>
                  ...
                  <div className="mt-20 pt-8 border-t-[0.5px] border-[#d4af37]/30 w-full max-w-xs md:max-w-md flex flex-col items-center gap-4">
                    <p className="text-[8px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.6em] text-[#f7e7ce]/50 font-bold leading-relaxed flex flex-col md:flex-row items-center gap-2 md:gap-4">
                      <span>© 2026 Gositha & Rangika</span>
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-[120] flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#3e1459] bg-white/95 text-[#3e1459] shadow-[0_0_0_4px_rgba(197,160,89,0.2),0_10px_36px_-6px_rgba(135,147,122,0.45)] backdrop-blur-md touch-manipulation transition-[transform,box-shadow] hover:scale-[1.05] hover:shadow-[0_0_0_5px_rgba(197,160,89,0.28),0_14px_44px_-6px_rgba(135,147,122,0.5)] active:scale-[0.96] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3e1459] focus-visible:ring-offset-2 focus-visible:ring-offset-[#fdfaf5]"
      >
    ...
    <div className="fixed top-4 left-4 z-[200] max-w-sm w-full bg-white/90 backdrop-blur-xl border border-theme-200 rounded-2xl shadow-2xl p-6 font-montserrat animate-in fade-in slide-in-from-left-4 duration-500">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-[#3e1459] text-white py-3 rounded-xl font-bold text-[10px] tracking-widest uppercase hover:bg-[#2a0a3f] transition-all"
        >
